...
ls $PATTERN/edge_weight_distribution.dat    | xargs ruby $script_dir/ensemble_averaging/ensemble_averaging.rb -f -l > edge_weight_distribution_ave.dat
...
ls $PATTERN/overlap_weight_correlation.dat  | xargs ruby $script_dir/ensemble_averaging/ensemble_averaging.rb -l > overlap_weight_correlation_ave.dat
...
ls $PATTERN/strength_distribution.dat       | xargs ruby $script_dir/ensemble_averaging/ensemble_averaging.rb -f -l > strength_distribution_ave.dat
